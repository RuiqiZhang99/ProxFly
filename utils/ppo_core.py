...
class MLPCritic(nn.Module):
    ...
    def __init__(self, obs_dim, hidden_sizes, activation, output_activation=nn.LeakyReLU):
        super().__init__()
        self.output_activation = output_activation
        self.v_net = mlp([obs_dim] + list(hidden_sizes) + [1], activation, output_activation=self.output_activation)
